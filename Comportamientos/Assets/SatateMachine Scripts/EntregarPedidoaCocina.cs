...
public class EntregarPedidoaCocina : StateMachineBehaviour {
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        ...
        {
            //waiter.transform.rotation = Quaternion.Lerp(waiter.transform.rotation, checkPoint.transform.rotation, looking);
        ...
        else if (waiter.agent.isStopped && looking >= 1 && !animator.IsInTransition(0) )
        {
